/*
# Keep missing Vault config from rolling back email changes

Vault lookups and mailer wake-up stay outside the enqueue path. If
get_vault_secret raises, the queued revert message still commits with
the Auth email update.
*/
